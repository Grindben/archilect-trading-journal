...
function buildPoolCard(container, pools, prefix){
  pools.forEach((pool,i)=>{
    ...
    const highBlock = el("div"); highBlock.style.display="flex"; highBlock.style.alignItems="center"; highBlock.style.gap="8px";
    ...
    const lowBlock = el("div"); lowBlock.style.display="flex"; lowBlock.style.alignItems="center"; lowBlock.style.gap="8px";
